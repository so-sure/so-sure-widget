...
SoSure.widget = function(apiKey) {
    ...
    this.bindButtons = function() {
        ...
        if (document.getElementById('sosure-prev-button-' + this.id)) {
            document.getElementById('sosure-prev-button-' + this.id).onclick = function() {
                this.displayPrev(true);
            }.bind(this);
        }
        if (document.getElementById('sosure-next-button-' + this.id)) {
            document.getElementById('sosure-next-button-' + this.id).onclick = function() {
